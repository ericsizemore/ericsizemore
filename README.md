...
| ⭐️ (1323) [igorw/evenement](https://github.com/igorw/evenement) | Événement is a very simple event dispatching library for PHP. (7 months ago) |
| ⭐️ (6) [ericsizemore/api](https://github.com/ericsizemore/api) | A simple wrapper/builder using Guzzle for base API clients. (8 months ago) |
...
| --- | --- | --- |
| [tempestphp/tempest-framework](https://github.com/tempestphp/tempest-framework) | The PHP framework that gets out of your way | [v1.6.0](https://github.com/tempestphp/tempest-framework/releases/tag/v1.6.0) (1 week ago) |
| [ericsizemore/php-project-template](https://github.com/ericsizemore/php-project-template) | Simple template repository for PHP libraries/projects. | [v2.0.0](https://github.com/ericsizemore/php-project-template/releases/tag/v2.0.0) (1 week ago) |
