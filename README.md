...
| --- | --- | --- |
| [ericsizemore/php-project-template](https://github.com/ericsizemore/php-project-template) | Simple template repository for PHP libraries/projects. | [v2.0.1](https://github.com/ericsizemore/php-project-template/releases/tag/v2.0.1) (today) |
| [ericsizemore/utility](https://github.com/ericsizemore/utility) | Collection of various PHP utility functions. | [v2.2.1](https://github.com/ericsizemore/utility/releases/tag/v2.2.1) (3 days ago) |
