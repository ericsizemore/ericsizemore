...
| --- | --- | --- |
| [ericsizemore/clock](https://github.com/ericsizemore/clock) | Yet another clock abstraction, implementing PSR-20. | [1.1.1](https://github.com/ericsizemore/clock/releases/tag/1.1.1) (1 day ago) |
...
| [ericsizemore/php-project-template](https://github.com/ericsizemore/php-project-template) | Simple template repository for PHP libraries/projects. | [v2.0.1](https://github.com/ericsizemore/php-project-template/releases/tag/v2.0.1) (2 weeks ago) |
