...
| --- | --- | --- |
| [ericsizemore/simple_counter](https://github.com/ericsizemore/simple_counter) | A simple PHP counter that counts your website visitors. | [v6.0.1](https://github.com/ericsizemore/simple_counter/releases/tag/v6.0.1) (2 days ago) |
| [ericsizemore/php-project-template](https://github.com/ericsizemore/php-project-template) | Simple template repository for PHP libraries/projects. | [v2.0.1](https://github.com/ericsizemore/php-project-template/releases/tag/v2.0.1) (4 days ago) |
